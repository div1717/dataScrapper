...
const TITLE_SELECTOR =
  "div[class='a-section a-spacing-none puis-padding-right-small s-title-instructions-style'] > h2 > a > span";
const RATING_SELECTOR = "div[class='a-row a-size-small'] > span:nth-child(1)";
const REVIEWS_SELECTOR = "div[class='a-row a-size-small'] > span:nth-child(2)";
const URL_SELECTOR =
